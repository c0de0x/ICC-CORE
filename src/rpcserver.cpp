...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ICC features */
        {"icc", "masternode", &masternode, true, true, false},
        {"icc", "masternodelist", &masternodelist, true, true, false},
        {"icc", "mnbudget", &mnbudget, true, true, false},
        {"icc", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"icc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"icc", "mnsync", &mnsync, true, true, false},
        {"icc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"icc", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use iccd, or the -server option to icc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> icc-cli " + methodname + " " + args + "\n";
}
