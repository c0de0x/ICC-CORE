...
#if defined(NDEBUG)
#error "ICC cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ICC Signed Message:\n";
...
int64_t GetBlockValue(int nHeight) {
    ...
    if (nHeight > 0 && nHeight <= 100) {
            ...
            nSubsidy = 1 * COIN;
        } else if (nHeight > 200 && nHeight <= 30000) {
            nSubsidy = 2 * COIN;
            ...
            nSubsidy = 6 * COIN;
        } else if (nHeight > 150000 && nHeight <= 180000) {
            nSubsidy = 7 * COIN;
        } else if (nHeight > 180000 && nHeight <= 210000) {
            nSubsidy = 8 * COIN;
        } else if (nHeight > 210000 && nHeight <= 240000) {
            nSubsidy = 7 * COIN;
        } else if (nHeight > 240000 && nHeight <= 270000) {
            nSubsidy = 6 * COIN;
        } else if (nHeight > 270000 && nHeight <= 300000) {
            nSubsidy = 5 * COIN;                                                                             
