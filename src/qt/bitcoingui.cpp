                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ICC-Coin") + " - ";
#ifdef ENABLE_WALLET
    ...
    if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #7FD8EE, stop: 1 #7FD8EE); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ICC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and icc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ICC Core"), this);
    aboutAction->setStatusTip(tr("Show information about ICC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ICC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ICC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ICC addresses"));
    ...
    openAction->setStatusTip(tr("Open a ICC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ICC Core help message to get a list with possible ICC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ICC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ICC network", "", count));
}
...
{
    QString strTitle = tr("ICC Core"); // default title
